...
public class Post_Book_SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post__book__search);

        posterUrl = getIntent().getExtras().getString("mThumbnail");
        ...
        String kitapname = getIntent().getExtras().getString("mTitle");
        String yazar = getIntent().getExtras().getString("mAuthors");
        ...
        txt_Gonder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Post_Book_SearchActivity.this, R.style.AlertDialogTheme);
                View view = LayoutInflater.from(Post_Book_SearchActivity.this).inflate(
                ...
                view.findViewById(R.id.buttonNo).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        alertDialog.cancel();
                        Toast.makeText(Post_Book_SearchActivity.this, "Gönderi Paylaşılamadı!", Toast.LENGTH_SHORT).show();
    ...
    private void resimYukle() {
        ...
        //resim yükle kodları
        final ProgressDialog progressDialog = new ProgressDialog(Post_Book_SearchActivity.this);
...
//                        benimUrim = indirmeUrisi.toString();
                        ...
                        resimUri=null;
                        videoUri=null;
                        startActivity(new Intent(Post_Book_SearchActivity.this, MainActivity.class));
                        finish();
                    } else {
                        Toast.makeText(Post_Book_SearchActivity.this, "Gönderme başarısız!", Toast.LENGTH_SHORT).show();
                    }
                }
            }).addOnFailureListener(new OnFailureListener() {
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(Post_Book_SearchActivity.this, " Seçilen resim yok.." + e.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
